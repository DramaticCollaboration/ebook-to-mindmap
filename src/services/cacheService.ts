...
// Chapter-level caching
    ...
    | 'overall_summary' // Overall summary of the book
    | 'combined_mindmap' // Mind map of the entire book (generated directly from the book's content)
    | 'merged_mindmap' // Merges mind maps (generated by merging chapter mind maps)
    | 'mindmap_arrows' // Mind map arrows
    | 'selected_chapters' // Selected chapters

// Define the type of cached value
export type CacheValue = string | MindElixirData | string[] | null

// Define the structure of cached items stored in localStorage
interface CacheItem {
  data: CacheValue
  timestamp: number
}
